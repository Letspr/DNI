...
function validarDni()
{
    ...
    switch (numero_dni[0].toUpperCase())
    {
        ...
        case "X":
            numero_dni = 0 + numero_dni.substr(1,numero_dni.length-1)
            break;
        case "Y":
            numero_dni = 1 + numero_dni.substr(1,numero_dni.length-1)
            break;
        case "Z":
            numero_dni = 2 + numero_dni.substr(1,numero_dni.length-1)
            break;
    }
